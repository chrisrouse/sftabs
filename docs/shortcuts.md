...
- [Setting Up Shortcuts in Firefox](#setting-up-shortcuts-in-firefox)
- [Setting Up Shortcuts in Chrome](#setting-up-shortcuts-in-chrome)
- [Best Practices](#best-practices)
- [Organizing Your Tabs for Shortcuts](#organizing-your-tabs-for-shortcuts)
...
2. **Access Keyboard Shortcuts**
   Click the gear icon (⚙️) in the top right and select "Manage Extension Shortcuts"
