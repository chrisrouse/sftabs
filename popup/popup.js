...
function loadUserSettings() {
	...
	return chrome.storage.sync.get('userSettings')
		.then((result) => {
...
function saveUserSettings() {
	...
	return chrome.storage.sync.set({ userSettings })
		.then(() => {
...
if (manageConfigButton) {
	manageConfigButton.addEventListener('click', () => {
		...
		chrome.tabs.create({ url: "/popup/import_export.html" }).then(() => {
...
function loadTabsFromStorage() {
	...
	chrome.storage.sync.get('customTabs')
		.then((result) => {
...
function saveTabsToStorage() {
	...
	chrome.storage.sync.set({ customTabs })
		.then(() => {
